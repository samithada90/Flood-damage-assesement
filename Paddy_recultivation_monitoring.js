...
// NDVI monitoring period
var preFloodStart = '2025-05-26';
var today         = '2026-02-09';
...
var s2raw = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED')
  .filterBounds(bounds)
  .filterDate(preFloodStart, today)
...
function compositeByStep(ic, startDateStr, endDateStr, stepDays) {
...
var s2 = compositeByStep(s2raw, preFloodStart, today, stepDays);
